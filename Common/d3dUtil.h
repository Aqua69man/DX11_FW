...
//#include <d3dx11.h>          // FarWinSDK
//#include <xnamath.h>		   // FarWinSDK
//#include <dxerr.h>		   // FarWinSDK
#include <DirectXMath.h>		// FarUPD_WinSDK
using namespace DirectX;		// FarUPD_WinSDK
